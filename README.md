...
> **版本说明：** 当前源码为 `3.2.0-preview.1` 预览版，最新稳定版为 `3.1.0`。精确源码版本见 [`version.json`](version.json)，正式发布版本与升级说明见 [GitHub Releases](https://github.com/yaojingang/GEOFlow/releases)。生产部署建议使用正式 Release，或固定到经过审核的提交。
...
| 组件 | 当前源码版本或状态 | 说明 |
|------|-------------------|------|
| GEOFlow Core | `3.2.0-preview.1` | Laravel 应用、管理后台、前台、API、队列和分发系统 |
