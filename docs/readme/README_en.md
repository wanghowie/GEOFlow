...
[![Source version](https://img.shields.io/badge/source-3.2.0--preview.1-2563eb)](../../version.json)
...
> **Version note:** The current source version is the `3.2.0-preview.1` preview. The latest stable release is `3.1.0`. See [`version.json`](../../version.json) for the exact source version and [GitHub Releases](https://github.com/yaojingang/GEOFlow/releases) for official releases and upgrade notes. Production deployments should use a stable release or pin a reviewed commit.
...
|-----------|----------------------------------|-------|
| GEOFlow Core | `3.2.0-preview.1` | Laravel application, admin, frontend, API, queues, and distribution system |
