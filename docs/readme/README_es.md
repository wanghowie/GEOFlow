...
|------------|------------------------------------|-------------|
| GEOFlow Core | `3.2.0-preview.1` | Aplicación Laravel, panel, frontend, API, colas y distribución |
