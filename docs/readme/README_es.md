...
|------------|------------------------------------|-------------|
| GEOFlow Core | `3.1.0` | Aplicación Laravel, panel, frontend, API, colas y distribución |
| GEOFlow CLI | `0.3.0-preview.1` | Incluido como `bin/geoflow`; compatible con macOS, Linux y WSL |
