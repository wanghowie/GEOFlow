...
> **Статус версии:** Текущая версия исходного кода: предварительная `3.2.0-preview.1`. Последняя стабильная версия: `3.1.0`. Точная версия исходного кода указана в [`version.json`](../../version.json), а официальные релизы и инструкции по обновлению доступны в [GitHub Releases](https://github.com/yaojingang/GEOFlow/releases). Для рабочего окружения используйте стабильный релиз или зафиксируйте проверенный коммит.
...
|-----------|--------------------------------------|----------|
| GEOFlow Core | `3.2.0-preview.1` | Приложение Laravel, панель, frontend, API, очереди и система публикации |
...
**Частные лица и компании могут пользоваться открытой версией GEOFlow без лицензионной платы, в том числе в коммерческих целях.** При соблюдении AGPL-3.0 перечисленные ниже сценарии не требуют отдельной коммерческой лицензии GEOFlow. Внутреннее использование в компании, обслуживание клиентов и взимание платы за услуги сами по себе не создают обязанности покупать коммерческую лицензию.

| Сценарий использования | Условия лицензирования |
|------------------------|------------------------|
| Самостоятельное обучение, исследования, преподавание, оценка возможностей и тестирование | Бесплатное использование, развёртывание и изменение |
| Внутреннее управление знаниями, создание контента, проверка качества с помощью ИИ и совместная работа | Бесплатное развёртывание для сотрудников, в том числе в коммерческих компаниях |
| Ведение собственного корпоративного сайта, сайта бренда, GEO-подканала или отраслевого информационного сайта | Бесплатное использование, включая коммерческую деятельность |
| Создание контента и ведение контентных проектов для клиентов агентствами, студиями или консультантами | Бесплатное использование; можно брать плату за создание контента, консультации и операционные услуги |
| Развёртывание, обучение, обслуживание или разработка на заказ для клиентов | Бесплатное использование с возможностью брать плату за услуги; при передаче копий ПО необходимо выполнять применимые требования AGPL к распространению и предоставлению исходного кода |
| Предоставление хостинга или онлайн-сервисов (SaaS) на основе GEOFlow | Бесплатное использование с возможностью брать плату за услуги; изменённые версии, доступные по сети, должны предлагать взаимодействующим с ними пользователям способ бесплатно получить полный соответствующий исходный код |
| Разработка на заказ, распространение, изменение брендинга или OEM-поставка с соблюдением AGPL | Бесплатное использование; сохраняйте обязательные уведомления и выполняйте применимые требования о сохранении той же лицензии и предоставлении исходного кода. Права на товарные знаки проверяются отдельно. |
| Необходимость исключения из требований AGPL к исходному коду или других условий, например для white-label, OEM или проприетарной интеграции, где код должен оставаться закрытым при применимости этих требований | Запросите отдельную коммерческую лицензию у правообладателя и используйте ПО согласно подписанному соглашению |

Перед использованием GEOFlow:

- **Внутреннее использование в компании также подчиняется применимым условиям.** Если сотрудники взаимодействуют с изменённой версией GEOFlow по сети, раздел 13 AGPL требует явно предложить им способ бесплатно получить полный соответствующий исходный код. Это же требование действует для изменённых сетевых сервисов, предоставляемых внешним пользователям. Круг получателей исходного кода зависит от способа использования и распространения; лицензия не требует размещать его в публичном репозитории GitHub, а получатели сохраняют предусмотренные лицензией права на дальнейшее распространение.
- **Деловые данные и исходный код оцениваются отдельно.** Независимые материалы базы знаний, данные клиентов и созданные статьи обычно не требуется раскрывать по AGPL только потому, что использовался GEOFlow. Если результат содержит код программы или другие произведения, подпадающие под лицензию, требования определяются его содержанием.
- **Бесплатность относится к лицензионной плате за ПО.** Серверы, домены, вызовы API моделей, сторонние сервисы и отдельно заказанная техническая поддержка оплачиваются пользователем.

Эти примеры поясняют существующую лицензию и не добавляют исключений. Применимые права и обязанности определены в [LICENSE](../../LICENSE); см. [раздел 13 AGPL](https://www.gnu.org/licenses/agpl-3.0.html#section13) и [пояснение GNU о результатах работы программ](https://www.gnu.org/licenses/gpl-faq.en.html#WhatCaseIsOutputGPL). Для сложных проприетарных интеграций или поставок с участием нескольких организаций рекомендуется предварительная юридическая оценка.
